...
export const mockTasks: Task[] = [
  {
    ...
    description: 'Create the initial project structure with all necessary folders and files for the Tasks Management application',
    status: 'completed',
    dueDate: '2025-07-15',
  ...
  },
  {
    ...
    description: 'Add comprehensive user authentication with login, registration, and session management functionality',
    status: 'in_progress',
    dueDate: '2025-07-20',
  ...
  },
  {
    ...
    description: 'Create comprehensive database schema for all application entities including users, tasks, and relationships',
    status: 'pending',
    dueDate: '2025-07-25',
  ...
  },
  {
    ...
    description: 'Implement full test coverage for all core functionality including CRUD operations, authentication, and edge cases',
    status: 'pending',
    dueDate: '2025-07-30',
  ...
  },
  {
    ...
    description: 'Set up CI/CD pipeline, configure production environment, and deploy the application with monitoring',
    status: 'pending',
    dueDate: '2025-08-05',
  ...
  },
  {
    ...
    description: 'Add WebSocket-based real-time notifications for task updates and team collaboration features',
    status: 'pending',
    dueDate: '2025-08-10',
  ...
  },
  {
    ...
    description: 'Optimize application performance including code splitting, lazy loading, and caching strategies',
    status: 'pending',
    dueDate: '2025-08-15',
